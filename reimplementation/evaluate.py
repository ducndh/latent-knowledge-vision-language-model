...
def main(args, generation_args):
    ...
    model_list=['meta-llama/Llama-3.2-3B-Instruct','Qwen/Qwen2.5-3B-Instruct']
    dataset_list=['dbpedia_14','ag_news','multi_nli',"gimmaru/story_cloze-2016","piqa"]
    split_list=['test','test','validation_mismatched','test','train']
