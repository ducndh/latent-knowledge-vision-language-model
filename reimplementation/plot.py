...
#plt.xlabel("Datasets",size=10,fontweight='bold')
#plt.ylabel("Layers",size=10,rotation=90,fontweight='bold')
#plt.title("Llama-3.2-3B-Instruct",size=15,fontweight='bold')
