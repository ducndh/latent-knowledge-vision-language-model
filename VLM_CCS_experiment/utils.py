...
def get_parser():
    ...
    parser.add_argument("--split", type=str, default="adversarial", help="Which split of the dataset to use")
    ...
    parser.add_argument("--label_dir", type=str, default=None, help="dir of label file")
    parser.add_argument("--file_dir", type=str, default='experiment data/POPE_hidden_results_full.pt')
